classdef MELTSdynamic < matlab.mixin.Copyable
    ...
    properties (SetAccess = protected)
        ...
        % the alphaMELTS for MATLAB/Python version. In a future version this value will be obtained from the C library of MELTS functions.
        version = '1.2.0beta'
    ...
    methods
        ...
        function printEngineInit(obj, cMode)
            ...
            switch cMode
                ...
                otherwise
                    obj.modeString = 'MELTS';
                    warning ('Unexpected value for calculationMode. Using 1 (rhyolite-MELTS 1.0.2)');
            end
